...
#emergency roach warren
            ...
            if self.supply_workers + self.already_pending(UnitTypeId.DRONE) < (enemy_townhalls.amount + 1) * 16 + (enemy_gas_buildings.amount + 2) * 3:
                if self.time > 240 and not enemies_near:
                    if (
                        self.supply_left > self.townhalls.amount
                        or self.already_pending(UnitTypeId.OVERLORD) >= 1
                        and not self.supply_left == 0
...
#overlord 1
        ...
        if self.overlord1 and self.can_afford(UnitTypeId.OVERSEER) and self.units(UnitTypeId.OVERSEER).amount + self.already_pending(UnitTypeId.OVERSEER) < 1:
...
#overlord 2
        ...
        if self.overlord2 and self.can_afford(UnitTypeId.OVERSEER) and self.units(UnitTypeId.OVERSEER).amount + self.already_pending(UnitTypeId.OVERSEER) < 2:
...
#overlord 3        
        ...
        if self.overlord3 and self.can_afford(UnitTypeId.OVERSEER) and self.units(UnitTypeId.OVERSEER).amount + self.already_pending(UnitTypeId.OVERSEER) < 3:
...
#overlord 4
        ...
        if self.overlord4 and self.can_afford(UnitTypeId.OVERSEER) and self.units(UnitTypeId.OVERSEER).amount + self.already_pending(UnitTypeId.OVERSEER) < 4:
...
#overlord 5
        ...
        if self.overlord5 and self.can_afford(UnitTypeId.OVERSEER) and self.units(UnitTypeId.OVERSEER).amount + self.already_pending(UnitTypeId.OVERSEER) < 5:
    ...
    async def build_gas(self):
        ...
        for hatch in self.townhalls.ready:
            ...
            if (
                ...
                and self.supply_workers + self.already_pending(UnitTypeId.DRONE) / 11 < self.structures(UnitTypeId.EXTRACTOR).amount + self.already_pending(UnitTypeId.EXTRACTOR)
                ):
                if (
                ...
                for gas in self.structures(UnitTypeId.EXTRACTOR):
                    if (
                        ...
                        for hatch in self.townhalls:
                            if hatch.assigned_harvesters + gas.assigned_harvesters + self.already_pending(UnitTypeId.DRONE) < hatch.ideal_harvesters + gas.ideal_harvesters:
                                makelings == False
                        if self.supply_workers + self.already_pending(UnitTypeId.DRONE) >= (enemy_townhalls.amount + 1) * 16 and makelings == True:
                            larva.train(UnitTypeId.ZERGLING)
...
#queens have an attack too
        for queen in queens:
            if enemies_near:
                ...
                if enemies_near.closer_than(17, self.townhalls.ready.in_closest_distance_to_group(enemies_near)) or enemies_near.closer_than(8, queen):
                    if (
                        ...
                        if enemies_near.closest_to(queen).ground_range < 5:
                            ...
                            stillattacking = True
                        if queen.is_attacking:
                            if enemies_near.closest_to(queen).ground_range > 2:
                                self.totalvalue_en = self.totalvalue_en * 0.5
                            if self.totalvalue_on <= self.totalvalue_en or queen.position.is_further_than(12, self.townhalls.closest_to(enemies_near.closest_to(queen))):
                ...
                if not self.has_creep(queen.position) or queen.is_idle:
                    if self.townhalls:
                        queen.move(self.townhalls.closest_to(enemies_near.closest_to(queen).position.towards(self.mineral_field.closest_to(self.townhalls.closest_to(queen)))))
                        print(self.townhalls.closest_to(enemies_near.closest_to(queen)).position.towards(self.mineral_field.closest_to(self.townhalls.closest_to(queen))))

            if not enemies_near:
                if queen.is_idle:
                    queen.move(self.townhalls.closest_to(queen).position.towards(self.mineral_field.closest_to(self.townhalls.closest_to(queen))))
...
#compare unit value
                ...
                for ling in lings:
                    if ling.position.is_further_than(10, enemies_near.closest_to(ling)):
                        if self.units(UnitTypeId.QUEEN):
                            if self.units(UnitTypeId.QUEEN).closest_to(enemies_near.closest_to(ling)).is_attacking or stillattacking == True:
                ...
                for ling in lings:
                    print("line1")
##                    if lings.furthest_to(self.townhalls.in_closest_distance_to_group(enemies_near)).position.distance_to(self.townhalls.in_closest_distance_to_group(enemies_near)) > enemies_near.closest_to(self.townhalls.in_closest_distance_to_group(enemies_near)).position.distance_to(self.townhalls.in_closest_distance_to_group(enemies_near)):
##                        stillattacking = True
##                        print("line1 success")
                    if ling.position.is_closer_than(10, enemies_near.closest_to(ling)):
                        ...
                        if self.townhalls:
                            if (
                                ...
                                if enemies_near.closest_to(ling).ground_range > 3:
                                    self.totalvalue_en = self.totalvalue_en * 0.5
                                if (
                                    ...
                                    if self.units(UnitTypeId.QUEEN):
                                        ling.move(self.units(UnitTypeId.QUEEN).closest_to(ling))
                                ...
                                self.totalvalue_on > self.totalvalue_en and not self.units(UnitTypeId.QUEEN)
                                or self.totalvalue_on >= self.totalvalue_en and self.units(UnitTypeId.QUEEN)
                                ...
                                if not self.units(UnitTypeId.QUEEN):
                                    if ling.weapon_cooldown == 0:
                                        ling.attack(enemies_near.closest_to(ling))
##                                    else:
##                                        ling.move(enemies_near.furthest_distance_to(lings.closest_to(self.townhalls.in_closest_distance_to_group(enemies_near))))
                                elif not self.units(UnitTypeId.QUEEN).closest_to(enemies_near.closest_to(ling)).is_attacking or not stillattacking == True:
                                    ling.move(self.units(UnitTypeId.QUEEN).closest_to(enemies_near.closest_to(ling)).position)
                                elif self.units(UnitTypeId.QUEEN).closest_to(enemies_near.closest_to(ling)).is_attacking or stillattacking == True:
                                    if len(ling.orders) < 2:
                                        if ling.weapon_cooldown == 0:
                                            ling.attack(enemies_near.closest_to(ling))
##                                        else:
##                                            ling.move(enemies_near.furthest_distance_to(lings.closest_to(self.townhalls.in_closest_distance_to_group(enemies_near))))
                                elif not ling.position.is_closer_than(5, self.units(UnitTypeId.QUEEN).closest_to(enemies_near.closest_to(ling))):
                                    ling.move(self.units(UnitTypeId.QUEEN).closest_to(enemies_near.closest_to(ling)).position)
                    ...
                    if self.townhalls:
                        if self.units(UnitTypeId.ROACH):
                            ...
                            if not self.townhalls.amount == enemy_townhalls.amount:
                                if not ling.position.is_closer_than(5, self.townhalls.ready.closest_to(enemymain).position.towards(self.units(UnitTypeId.QUEEN).closest_to(ling), 5)):
                                    ling.move(self.townhalls.ready.closest_to(enemymain).position.towards(self.units(UnitTypeId.QUEEN).closest_to(enemynat), 5))
                            if self.townhalls.amount == enemy_townhalls.amount:
                                if not ling.position.is_closer_than(5, self.townhalls.closest_to(enemymain).position.towards(self.units(UnitTypeId.QUEEN).closest_to(ling), 5)):
                                    ling.move(self.townhalls.closest_to(enemymain).position.towards(self.units(UnitTypeId.QUEEN).closest_to(enemynat), 5))
                        else:
                            if not self.townhalls.amount == enemy_townhalls.amount:
                                if not ling.position.is_closer_than(5, self.townhalls.ready.closest_to(enemymain).position.towards(enemymain, 7)):
                                    ling.move(self.townhalls.ready.closest_to(enemymain).position.towards(enemymain, 4))
                            if self.townhalls.amount == enemy_townhalls.amount:
                                if not ling.position.is_closer_than(5, self.townhalls.ready.closest_to(enemymain).position.towards(enemymain, 7)):
                                    ling.move(self.townhalls.closest_to(enemymain).position.towards(enemymain, 4))
...
#if further away then go to attack formation                            
                for ling in lings:
                    if not ling.position.is_closer_than(10, allenemies.closest_to(ling)) or ling.is_idle:
...
##group
            if not enemies_near and not enemies_structures_near and self.supply_used < 180:
                ...
                for roach in roaches:
                    if not self.townhalls.amount == enemy_townhalls.amount and not roach.position.is_closer_than(5, self.townhalls.ready.closest_to(enemymain).position.towards(enemymain, 7)):
                        roach.move(self.townhalls.ready.closest_to(enemymain).position.towards(enemymain, 4))
                    if self.townhalls.amount == enemy_townhalls.amount and not roach.position.is_closer_than(5, self.townhalls.ready.closest_to(enemymain).position.towards(enemymain, 7)):
                        roach.move(self.townhalls.closest_to(enemymain).position.towards(enemymain, 4))
                ...
                for roach in roaches:
                    if (
                        ...
                        if roaches.further_than(10, allenemies.closest_to(roach)):
                            if allenemies.closest_to(roach).position.distance_to(roaches.further_than(10, allenemies.closest_to(roach)).closest_to(roach)) > roach.position.distance_to(roaches.further_than(10, allenemies.closest_to(roach)).closest_to(roach)):
                                roach.move(roaches.further_than(10, allenemies.closest_to(roach)).closest_to(roach))
                            elif allenemies.closest_to(roach).position.distance_to(roaches.further_than(10, allenemies.closest_to(roach)).closest_to(roach)) > roach.position.distance_to(self.townhalls.closest_to(roach)):
                                roach.move(self.townhalls.closest_to(roach))
                            else:
                                roach.move(allenemies.closest_to(roach).position.towards(roach, 11))
                    elif (
                        self.totalvalue_on >= self.totalvalue_en
                        ):
                        if (
...
##attack
    ...
    async def build_roaches(self):
        ...
        if (
            ...
            if (
                ...
                and enemies_near
                and not self.totalvalue_o > self.totalvalue_e * 10
                or self.supply_cap > 199
                and enemies_near
                ):
    ...
    async def build_queens(self):
        ...
        if self.can_afford(UnitTypeId.QUEEN) and self.units(UnitTypeId.QUEEN).amount + self.already_pending(UnitTypeId.QUEEN) <= self.townhalls.amount and not self.wallqueen:
            if self.already_pending(UnitTypeId.EVOLUTIONCHAMBER) or self.structures(UnitTypeId.EVOLUTIONCHAMBER):
                self.train(UnitTypeId.QUEEN, 1)
                
        if self.enemyworkers < 15 and self.can_afford(UnitTypeId.QUEEN) and self.larva.amount < 1:
            self.train(UnitTypeId.QUEEN, 1)
    ...
    async def split_queens(self):
        ...
        if queens.amount + self.already_pending(UnitTypeId.QUEEN) < self.townhalls.amount and self.can_afford(UnitTypeId.QUEEN) and self.townhalls.ready.idle:
            self.train(UnitTypeId.QUEEN, 1)
