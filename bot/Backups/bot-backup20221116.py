...
#early aggression back to droning after ling scout if we overbuilt units
            if (
                ...
                if (
                    ...
                    larva.train(UnitTypeId.DRONE)
                    #print(self.time_formatted, self.supply_used, "our combat units =", self.units.exclude_type((UnitTypeId.EGG, UnitTypeId.DRONE, UnitTypeId.OVERLORD, UnitTypeId.LARVA)).amount)
...
#stay 1 base ahead of them
            ...
            if (
                ...
                if (
                    ...
                    if (
                        ...
                        #print(self.time_formatted, self.supply_used, "Building Gas")
                elif self.supply_workers + self.already_pending(UnitTypeId.DRONE) >= (self.structures(UnitTypeId.HATCHERY).amount * 16) + (self.structures(UnitTypeId.EXTRACTOR).amount * 3) and self.minerals > 500:
                    if (
                        not self.gas_buildings.closer_than(1, geysernear)
                        and not self.already_pending(UnitTypeId.EXTRACTOR)
                        and self.vespene < self.minerals
    ...
    async def units_value_check(self):
        ...
        if self.units.exclude_type((UnitTypeId.EGG, UnitTypeId.DRONE, UnitTypeId.OVERLORD, UnitTypeId.LARVA)):
            for unit in self.units.exclude_type((UnitTypeId.EGG, UnitTypeId.DRONE, UnitTypeId.OVERLORD, UnitTypeId.LARVA)):
...
#defensive lings:
            if (
                self.enemy_units.not_flying.closer_than(70, self.start_location).amount > 1
...
#defend against the worker rush!
        for drone in self.units(UnitTypeId.DRONE).ready:
            if self.time < 30 and self.enemy_units.not_flying.closer_than(10, drone).amount > 2:
                self.units(UnitTypeId.DRONE).furthest_to(self.start_location).gather(self.mineral_field.closest_to(self.structures(UnitTypeId.HATCHERY).closest_to(self.start_location)))
            if self.time > 40 and self.time < 50 and self.alert(Alert.UnitUnderAttack):
                ...
                self.units(UnitTypeId.DRONE).furthest_to(self.start_location).gather(self.mineral_field.closest_to(self.structures(UnitTypeId.HATCHERY).closest_to(self.start_location)), queue = True)
            ...
            if drone.is_attacking:
                if self.enemy_units.not_flying.closer_than(9, self.start_location).amount < 1 and self.enemy_structures.not_flying.closer_than(10, self.start_location).amount < 1:
                    drone.gather(self.mineral_field.closest_to(self.structures(UnitTypeId.HATCHERY).closest_to(self.start_location)))
            ...
            if (
                ...
                if len(queen.orders) > 0:
                    ...
                    if (
                        ...
                        queen.move(self.structures(UnitTypeId.HATCHERY)).closest_to(queen)

#check enemy units if enemies nearby
            if not self.nearby_enemy_units:
                if self.enemy_units.exclude_type((UnitTypeId.EGG, UnitTypeId.DRONE, UnitTypeId.OVERLORD, UnitTypeId.LARVA)).closer_than(10, self.units.exclude_type((UnitTypeId.EGG, UnitTypeId.DRONE, UnitTypeId.OVERLORD, UnitTypeId.LARVA)).closest_to(possible_base_locations[0])):
                    self.nearby_enemy_units = self.enemy_units.exclude_type((UnitTypeId.EGG, UnitTypeId.DRONE, UnitTypeId.OVERLORD, UnitTypeId.LARVA)).closer_than(10, self.units.exclude_type((UnitTypeId.EGG, UnitTypeId.DRONE, UnitTypeId.OVERLORD, UnitTypeId.LARVA)).closest_to(possible_base_locations[0])).tags
            if self.nearby_enemy_units:
                if len(self.enemy_units.exclude_type((UnitTypeId.EGG, UnitTypeId.DRONE, UnitTypeId.OVERLORD, UnitTypeId.LARVA)).closer_than(10, self.units.exclude_type((UnitTypeId.EGG, UnitTypeId.DRONE, UnitTypeId.OVERLORD, UnitTypeId.LARVA)).closest_to(possible_base_locations[0])).tags) > len(self.nearby_enemy_units):
                    self.nearby_enemy_units = self.enemy_units.exclude_type((UnitTypeId.EGG, UnitTypeId.DRONE, UnitTypeId.OVERLORD, UnitTypeId.LARVA)).closer_than(10, self.units.exclude_type((UnitTypeId.EGG, UnitTypeId.DRONE, UnitTypeId.OVERLORD, UnitTypeId.LARVA)).closest_to(possible_base_locations[0])).tags
                if len(self.enemy_units.exclude_type((UnitTypeId.EGG, UnitTypeId.DRONE, UnitTypeId.OVERLORD, UnitTypeId.LARVA)).closer_than(10, self.units.exclude_type((UnitTypeId.EGG, UnitTypeId.DRONE, UnitTypeId.OVERLORD, UnitTypeId.LARVA)).closest_to(possible_base_locations[0])).tags) < len(self.nearby_enemy_units):
                    self.nearby_enemy_units = self.enemy_units.exclude_type((UnitTypeId.EGG, UnitTypeId.DRONE, UnitTypeId.OVERLORD, UnitTypeId.LARVA)).closer_than(10, self.units.exclude_type((UnitTypeId.EGG, UnitTypeId.DRONE, UnitTypeId.OVERLORD, UnitTypeId.LARVA)).closest_to(possible_base_locations[0])).tags
...
#check our units including itself if enemy units nearby
                if not self.nearby_friendly_units:
                    self.nearby_friendly_units = self.units.exclude_type((UnitTypeId.EGG, UnitTypeId.DRONE, UnitTypeId.OVERLORD, UnitTypeId.LARVA)).closer_than(10, self.units.exclude_type((UnitTypeId.EGG, UnitTypeId.DRONE, UnitTypeId.OVERLORD, UnitTypeId.LARVA)).closest_to(possible_base_locations[0])).tags
                if len(self.units.exclude_type((UnitTypeId.EGG, UnitTypeId.DRONE, UnitTypeId.OVERLORD, UnitTypeId.LARVA)).closer_than(10, self.units.exclude_type((UnitTypeId.EGG, UnitTypeId.DRONE, UnitTypeId.OVERLORD, UnitTypeId.LARVA)).closest_to(possible_base_locations[0])).tags) > len(self.nearby_friendly_units):
                    self.nearby_friendly_units = self.units.exclude_type((UnitTypeId.EGG, UnitTypeId.DRONE, UnitTypeId.OVERLORD, UnitTypeId.LARVA)).closer_than(10, self.units.exclude_type((UnitTypeId.EGG, UnitTypeId.DRONE, UnitTypeId.OVERLORD, UnitTypeId.LARVA)).closest_to(possible_base_locations[0])).tags
                if len(self.units.exclude_type((UnitTypeId.EGG, UnitTypeId.DRONE, UnitTypeId.OVERLORD, UnitTypeId.LARVA)).closer_than(10, self.units.exclude_type((UnitTypeId.EGG, UnitTypeId.DRONE, UnitTypeId.OVERLORD, UnitTypeId.LARVA)).closest_to(possible_base_locations[0])).tags) < len(self.nearby_friendly_units):
                    self.nearby_friendly_units = self.units.exclude_type((UnitTypeId.EGG, UnitTypeId.DRONE, UnitTypeId.OVERLORD, UnitTypeId.LARVA)).closer_than(10, self.units.exclude_type((UnitTypeId.EGG, UnitTypeId.DRONE, UnitTypeId.OVERLORD, UnitTypeId.LARVA)).closest_to(possible_base_locations[0])).tags
        ...
        if lings:
            ...
            if self.closestlingtag:
                ...
                if self.closestling:
                    ...
                    if (
                        not self.enemy_structures.not_flying.closer_than(70, self.start_location)
                        and not self.enemy_units.not_flying.exclude_type(scouts).closer_than(70, self.start_location).amount > 0
                    ...
                    if self.enemy_units.not_flying.exclude_type(scouts).closer_than(10, self.closestling).amount > 2 and not self.enemy_units.not_flying.exclude_type(scouts).closer_than(4, self.structures(UnitTypeId.HATCHERY).closest_to(possible_base_locations[0])):
                        self.closestling.move(self.structures(UnitTypeId.HATCHERY).ready.closest_to(possible_base_locations[0]).position)
                        print(self.time_formatted, self.supply_used, "closest ling retreating")
                        
        if self.structures(UnitTypeId.HATCHERY):
            if (
                not self.totalvalue_on > self.totalvalue_en and not self.enemy_units.not_flying.exclude_type(scouts).closer_than(4, self.structures(UnitTypeId.HATCHERY).closest_to(possible_base_locations[0]))
                or self.time < 180 and not self.enemy_units.not_flying.exclude_type(scouts).closer_than(4, self.structures(UnitTypeId.HATCHERY).closest_to(possible_base_locations[0]))
                ):
                if lings:
                    if lings.closer_than(5, self.units.exclude_type((UnitTypeId.EGG, UnitTypeId.DRONE, UnitTypeId.OVERLORD, UnitTypeId.LARVA)).closest_to(possible_base_locations[0]).position):
                        for ling in lings.closer_than(5, self.units.exclude_type((UnitTypeId.EGG, UnitTypeId.DRONE, UnitTypeId.OVERLORD, UnitTypeId.LARVA)).closest_to(possible_base_locations[0])):
                            ling.move(self.structures(UnitTypeId.HATCHERY).ready.closest_to(possible_base_locations[0]).position)
                if roaches:
                    if roaches.closer_than(5, self.units.exclude_type((UnitTypeId.EGG, UnitTypeId.DRONE, UnitTypeId.OVERLORD, UnitTypeId.LARVA)).closest_to(possible_base_locations[0]).position):
                        for roachn in roaches.closer_than(10, self.units.exclude_type((UnitTypeId.EGG, UnitTypeId.DRONE, UnitTypeId.OVERLORD, UnitTypeId.LARVA)).closest_to(possible_base_locations[0])):
                            roachn.move(self.structures(UnitTypeId.HATCHERY).ready.closest_to(possible_base_locations[0]).position)
...
#defend
                if (
                    self.enemy_units.not_flying.exclude_type(scouts).closer_than(40, self.start_location).amount > 0
                    and self.totalvalue_on > self.totalvalue_en
                    ):
                    ling.attack(self.enemy_units.not_flying.exclude_type(scouts).closer_than(40, self.start_location).closest_to(ling))
...
#group
                if (
                    ...
                    and not self.enemy_units.not_flying.exclude_type(scouts).closer_than(40, self.start_location).amount > 0
                    and self.supply_used < 190
                    ):
                    ling.move(self.structures(UnitTypeId.HATCHERY).ready.closest_to(self.enemy_start_locations[0]).position.towards(self.enemy_start_locations[0], 4))
...
#defend
            if (
                ...
                if (
                    ...
                    roach.attack(self.enemy_units.not_flying.exclude_type(scouts).closer_than(40, self.start_location).closest_to(roach))
                    ...
                    if (
                        roach.target_in_range(self.enemy_units.not_flying.exclude_type(scouts).closer_than(40, self.start_location).closest_to(roach))
                        and self.enemy_units.not_flying.exclude_type(scouts).closer_than(40, self.start_location).closest_to(roach).ground_range < 4
                        ):
                        roach.move(self.enemy_units.not_flying.exclude_type(scouts).closer_than(40, self.start_location).closest_to(roach).position.towards(self.enemy_units.not_flying.exclude_type(scouts).closer_than(40, self.start_location).closest_to(roach)), -3)
                    else:
                        roach.move(self.enemy_units.not_flying.exclude_type(scouts).closer_than(40, self.start_location).closest_to(roach).position)
            if (
...
#group
            if (
                ...
                roach.move(self.structures(UnitTypeId.HATCHERY).ready.closest_to(self.enemy_start_locations[0]).position.towards(self.enemy_start_locations[0], 7))
#attack units first
            if (
                self.enemy_units.not_flying.exclude_type((UnitTypeId.EGG, UnitTypeId.LARVA)).amount > 0
                and not self.enemy_structures.not_flying.closer_than(70, self.start_location).amount > 0
                ...
                if (
                    ...
                    if (
                        ...
                        roach.move(self.enemy_units.not_flying.exclude_type((UnitTypeId.EGG, UnitTypeId.LARVA)).closest_to(roach).position.towards(self.enemy_units.not_flying.exclude_type((UnitTypeId.EGG, UnitTypeId.LARVA)).closest_to(roach)), -3)
                    else:
