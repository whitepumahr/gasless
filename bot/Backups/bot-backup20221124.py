                                ...
                                if (
                                    ...
                                    if (
                                        ...
                                        if (
                                            ...
                                            if self.townhalls.amount == 3 and enemy_townhalls.amount >= 3 and self.time < 160:
                                                larva.train(UnitTypeId.DRONE)
                                                print(self.time_formatted, self.supply_used, "building enough drones to match base count against gasless opponent with our 3 base")
                                            if self.townhalls.amount == 3 and self.already_pending(UnitTypeId.HATCHERY) == 1 and self.time < 220 or self.townhalls.amount == 4 and enemy_townhalls.amount >= 4 and self.time < 190:
                                                larva.train(UnitTypeId.DRONE)
                                                print(self.time_formatted, self.supply_used, "building enough drones to match base count against gasless opponent with our 4 base")
                                            if self.townhalls.amount == 4 and self.already_pending(UnitTypeId.HATCHERY) == 1 or self.townhalls.amount == 5 and enemy_townhalls.amount >= 5 and self.time < 220:
                                                larva.train(UnitTypeId.DRONE)
                                                print(self.time_formatted, self.supply_used, "building enough drones to match base count against gasless opponent with our 5 base")
                                            if self.townhalls.amount > 5:
                                                larva.train(UnitTypeId.DRONE)
                                                print(self.time_formatted, self.supply_used, "building enough drones to match base count against gasless opponent with our 6+ base")
...
#overlord 2
        ...
        if self.overlord2:
            if (
                ...
                and self.units(UnitTypeId.OVERLORD).idle.closer_than(19, possible_base_locations[1].position)
                ):
...
#hatchery zonal defense system
        for hatch in self.townhalls:
            ...
            if not enemies_structures_near:
            ...
            if self.closestlingtag2:
                ...
                if self.closestling2:
                    ...
                    if (
                        ...
                        and len(self.closestling2.orders) < 2
                        ):
...
#check our units including itself if enemy units nearby
                ...
                if (
                    enemies_structures_near.amount > 0
                    and not enemies_near.amount > 0
...
#group
                if (
                    self.totalvalue_o > 0
                    and not enemies_structures_near.amount > 0
                    and not enemies_near.amount > 0
