...
class CompetitiveBot(BotAI):
    ...
    async def building_cancel_check(self):
        if self.structures(UnitTypeId.HATCHERY).not_ready:
            for hatch in self.structures(UnitTypeId.HATCHERY).not_ready:
...
#defend
                    if (
                        self.enemy_units.not_flying.exclude_type(scouts).closer_than(40, hatch).amount > 0
                        and self.totalvalue_on > self.totalvalue_en
                        ):
                        ling.attack(self.enemy_units.not_flying.exclude_type(scouts).closer_than(40, hatch).closest_to(ling))
                        
                    if (
                        self.enemy_structures.not_flying.closer_than(70, self.start_location)
                        and not self.enemy_units.not_flying.exclude_type(scouts).closer_than(40, hatch).amount > 0
                        and self.totalvalue_on > self.totalvalue_en
                        ):
...
#group
                    if (
                        ...
                        if not ling.position.is_closer_than(5, self.structures(UnitTypeId.HATCHERY).ready.closest_to(self.enemy_start_locations[0]).position.towards(self.enemy_start_locations[0], 7)):
...
#defend
                if (
                    ...
                    if (
                        ...
                        roach.attack(self.enemy_units.not_flying.exclude_type(scouts).closer_than(40, hatch).closest_to(roach))
                        ...
                        if (
                            roach.target_in_range(self.enemy_units.not_flying.exclude_type(scouts).closer_than(40, hatch).closest_to(roach))
                            and self.enemy_units.not_flying.exclude_type(scouts).closer_than(40, hatch).closest_to(roach).ground_range < 4
                            ):
                            roach.move(self.enemy_units.not_flying.exclude_type(scouts).closer_than(40, hatch).closest_to(roach).position.towards(roach, 4))
                        else:
                            roach.move(self.enemy_units.not_flying.exclude_type(scouts).closer_than(40, hatch).closest_to(roach).position)
                if (
...
#group
                if (
                    ...
                    if not roach.position.is_closer_than(5, self.structures(UnitTypeId.HATCHERY).ready.closest_to(self.enemy_start_locations[0]).position.towards(self.enemy_start_locations[0], 7)):
