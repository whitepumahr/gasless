...
#spawn more overlords
        ...
        if self.supply_cap < 200:
            if (
                ...
                print(self.time_formatted, self.supply_used, "condition 1")
            if self.
            if (
                ...
                if (
                    ...
                    larva.train(UnitTypeId.OVERLORD)
                    print(self.time_formatted, self.supply_used, "condition 2")
            if (
                ...
                larva.train(UnitTypeId.OVERLORD)
                print(self.time_formatted, self.supply_used, "condition 3")
            if (
                self.time < 80
                and self.can_afford(UnitTypeId.OVERLORD)
                ...
                if self.enemyworkers < 15 and enemy_townhalls.amount < 2:
                    larva.train(UnitTypeId.OVERLORD)
                    print(self.time_formatted, self.supply_used, "condition 4")
